 ...
 * child: an in-process native reader ([nativeRun], in libfateh7_logcat.so) reads logd directly through
...
object LogTail {
    ...
    /**
     * Load libfateh7_logcat.so from [nativeLib] and start the reader on its own daemon thread. Called
